...
',
    ...
    'user.list.title' => 'List Users',
    'user.list.name' => 'Name',
    'user.list.first_name' => 'First name',
    'user.list.birth' => 'Birth Day',
    'user.list.update' => 'Update',
    'user.list.delete' => 'Delete',
    'user.list.refresh' => 'Refresh',
    'user.list.add_user' => 'Add User',
    'user.list.drop_msg' => 'Do you really want delete this line?',
  ),
  'validators' => 
  array (
...
$catalogue->addFallbackCatalogue(new MessageCatalogue('fr', array (
  'validators' => 
  array (
...
',
    ...
    'user.list.title' => 'Liste des Utlilisateurs',
    'user.list.name' => 'Nom',
    'user.list.first_name' => 'Prenom',
    'user.list.birth' => 'Date Naissance',
    'user.list.update' => 'Modifier',
    'user.list.delete' => 'Supprimer',
    'user.list.refresh' => 'Actualiser',
    'user.list.add_user' => 'Ajouter Utilisateur',
    'user.list.drop_msg' => 'Voulez vous vraiment supprimer cette ligne?',
  ),
  'messages' => 
  array (
    'Symfony2 is great' => 'J\'aime Symfony2',
    'coresphere_console.headline.index' => 'Console',
    'coresphere_console.working_directory' => 'Développement',
    'coresphere_console.environment' => 'Environnement',
    'coresphere_console.welcome_message' => 'Tapez "%command%" pour voir la list de tous les commandes.',
    'coresphere_console.loading' => 'chargemnt...',
    'coresphere_console.suggestion_head' => 'voulez-vous dire:',
    'coresphere_console.empty_response' => 'Complete!',
  ),
)));
